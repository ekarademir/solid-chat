...
use http::{Method, HeaderValue, header::HeaderName};

use crate::services::tenants::{TenantsService, TenantsServer};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let cors = CorsLayer::new()
      ...
      .allow_headers(Any)
      .expose_headers([grpc_encoding_header, grpc_message_header, grpc_status_header]);
